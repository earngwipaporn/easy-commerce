...
<template>
    <div class="container mx-auto">
        <div class="navbar bg-base-100">
            <div class="flex-1">
                <RouterLink :to="{ name: 'home'}" class="btn btn-ghost normal-case text-xl">EarngShop</RouterLink>
            </div>
            <div class="flex-none">
                <div class="form-control">
                    <input type="text" placeholder="Search" v-model="searchText" @keyup="handleSearch" class="input input-bordered w-24 md:w-auto" />
                </div>
                ...
                <div v-if="!isLoggedIn"><button class="btn btn-ghost" @click="login()">Login</button></div>
                <div class="dropdown dropdown-end" v-else="isLoggedIn">
                    <label tabindex="0" class="btn btn-ghost btn-circle avatar">
                        <div class="w-10 rounded-full">
                            <img
                                :src="profileStore.users.imageUrl"/>
                        </div>
                    </label>
                    <ul tabindex="0"
